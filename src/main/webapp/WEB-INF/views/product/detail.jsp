						...
						<form action="/product/comment" method="post"
							...
							<div class="d-flex flex-start w-100">
								<img class="rounded-circle shadow-1-strong me-3 mr-2"
									src="/static/images/customers/${user.photo}" alt="avatar"
									width="40" height="40" />
								<div class="form-outline w-100">
									<textarea placeholder="Nhập bình luận tại đây" required="true"
										class="form-control" name="content" id="textAreaExample"
...
<c:choose>
	<c:when test="${prod.comments.size() > 0 }">
		<section class="container-fluid gradient-custom">
			<div class="container-fluid my-5 py-5">
				<div class="row d-flex justify-content-center">
					<div class="col-md-12 col-lg-10 col-xl-8">
						<div class="card">
							<div class="card-body p-4">
								...
								<c:forEach var="c" items="${prod.comments}">
									<c:choose>
										<c:when test="${empty c.parentComment}">
											<div class="row">
												<div class="col">
														...
														<div class="flex-grow-1 flex-shrink-1">
															<div>
																<div
																	...
																	<p class="mb-1">
																		${c.user.fullname} <span class="small">- 2
																			hours ago</span>
																	</p>
																	<a href="#!" onclick="reply(${c.id})"><i
															...
															<c:choose>
																<c:when test="${c.childComments.size() > 0 }">
																	<c:forEach var="cc" items="${c.childComments}">
																		<div class="d-flex flex-start mt-4">
																			<a class="me-3" href="#"> <img
																				class="rounded-circle shadow-1-strong mr-2"
																			...
																			<div class="flex-grow-1 flex-shrink-1">
																				<div>
																					<div
																						class="d-flex justify-content-between align-items-center">
																						<p class="mb-1">
																							${cc.user.fullname} <span class="small">-
																								3 hours ago</span>
																						</p>
																					</div>
																					<p class="small mb-0">${cc.content}</p>
																				</div>
																			</div>
																		</div>
																	</c:forEach>
...
function reply(id){
	$('#' + id).replaceWith(`<div class="card mt-4 mb-4" id=$(id)>
			<div class="card-footer py-3 border-0"
			style="background-color: #f8f9fa;">
			<form action="/product/comment" method="post"
				enctype="multipart/form-data">
				<div class="d-flex flex-start w-100">
					...
					<div class="form-outline w-100">
						<textarea placeholder="Nhập bình luận tại đây"
							...
							id="textAreaExample" rows="4" required="true"
